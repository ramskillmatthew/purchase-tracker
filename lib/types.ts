...
export type Purchase = { id: string; order_date: string; purchased_from: string; seller_name: string; sku: string; item_description: string; item_size: string; quantity: number; item_condition: string; price_purchased: number; arrived: boolean | null; stock_status: StockStatus; created_at: string };
